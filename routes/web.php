...
Route::get('/dashboard', function () {
    $tenant_user = TenantUser::where('user_id', Auth::id())->first();
...
Route::post('/login', [AuthenticatedSessionController::class, 'store'])->middleware('guest')->name('signin');

Route::get('/register', [RegisteredTenantController::class, 'create'])->middleware('guest')->name('register');
Route::post('/register', [RegisteredTenantController::class, 'store'])->middleware('guest')->name('signup');
